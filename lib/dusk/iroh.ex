defmodule Dusk.Iroh do
  @moduledoc "Iroh (iron) endpoint wrapper. Optional `iroh_beam`."
  use GenServer
  require Logger
  ...
  def init(opts) do
    if available?() do
      start_opts = [
        ...
        alpns: Keyword.get(opts, :alpns, ["dusk/1"]),
      ...
      Logger.warning("iroh_beam not loaded; Dusk.Iroh stub")
