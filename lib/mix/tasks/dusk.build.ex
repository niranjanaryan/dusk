defmodule Mix.Tasks.Dusk.Build do
  @moduledoc false
  use Mix.Task

  @shortdoc "Builds the Dusk Zig NIF"
  @recursive true
  ...
  def run(_args) do
    ...
    if need do
      ...
      IO.write(out)
      if exit != 0, do: raise("Failed to compile Dusk Zig NIF")
    end
  end
